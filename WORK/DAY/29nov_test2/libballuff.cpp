...
uint8_t Balluff::endpoint_driver_init(uint32_t* data_cube_addr,uint32_t* meta_data_cube_addr)
{
    ...
    /*if (data_cube_addr != meta_data_cube_addr)
    {
    ...
    {
	    cout <<data_cube_addr<< endl;
	    data_cube_addr++;
    }
    cout<<endl<<"\n";
    for (ret=0;ret<12;ret++)
    {
	    cout <<meta_data_cube_addr << endl;
	    meta_data_cube_addr++;
    }*/
    ...
    for (ret=0;ret<12;ret++)
    {
        uint32_t error;
        data_addresses data;
        data.data_cube_address =data_cube_addr;
        data.meta_data_cube_address =meta_data_cube_addr;
        data.index = index_n++;
	...
	cout<<data.data_cube_address<<endl;
	data_cube_addr++;
