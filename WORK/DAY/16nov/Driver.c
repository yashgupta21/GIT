...
{	
        ...
        switch(cmd)
	{
		...
		case IOCTL_RD_FPGA_REGISTER:
			...
			//recVariable.value=&newVar;
			recVariable.offset=2000;
			recVariable.size=10;
			memcpy(recVariable.value,&newVar, sizeof(newVar));
			//recVariable.value=&newVar;
			//recVariable.value=(char)newVar;
			pr_info("Value in kernel = %d\n",(*(uint16_t *)recVariable.value));
